    ...
    <div className="relative">
      ...
      <section className="relative min-h-[65vh] flex items-center overflow-hidden">
        ...
        <div className="section-container relative z-10 pt-28 pb-16 text-center">
          ...
          >
            <span className="pill-badge mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore the technical architecture and vision behind NOVAInetwork.
              Discover how AI-integration transforms blockchain infrastructure from the ground up.
            </p>
          </motion.div>
        </div>
      </section>
