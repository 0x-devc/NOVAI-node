...
function TerminalAnimation() {
  ...
  return (
    <div
      className="rounded-xl overflow-hidden text-left font-mono text-xs sm:text-sm"
      style={{
        ...
        {lines.map((line, i) => (
          <motion.div
            ...
            className={`mb-1 ${
              line.startsWith("$")
                ? "text-accent"
                : line.includes("OPTIMAL") || line.includes("ACTIVE")
                ? "text-green-400"
                : line.includes("finalized")
                ? "text-primary/80"
...
function EmailSignup() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!apiUrl) {
      setStatus("error");
      setErrorMsg("Signup is not available right now. Please try again later.");
      return;
    }
  ...
  if (status === "success") {
    return (
      <motion.div
        ...
        className="glass-card rounded-2xl px-6 py-5 inline-flex items-center gap-3"
      >
          ...
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            ...
            >
              ...
              <h1 className="font-display text-4xl font-bold sm:text-5xl lg:text-6xl mb-6 leading-[1.1]">
                The NOVAInetwork Testnet is{" "}
                <span className="gradient-text">Coming Soon</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-lg">
                We're preparing something special. The public testnet will let you experience
                AI-native blockchain infrastructure firsthand.
              </p>
              ...
              <div className="glass-card rounded-2xl px-6 py-5 flex items-center gap-4 mb-8 max-w-sm">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">Testnet Status</p>
                  <p className="text-xs text-accent">In Development</p>
                </div>
              </div>

              <p className="text-sm text-muted-foreground mb-6">
                Join our community to be the first to know when it goes live.
              </p>
      ...
      <section className="relative py-24">
        ...
        <div className="section-container py-20">
          <ScrollSection>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto">
                The public testnet will showcase the core capabilities of the NOVAInetwork protocol.
              </p>
            </div>
          </ScrollSection>
          ...
          <div className="grid gap-6 sm:grid-cols-3 max-w-4xl mx-auto">
            {[
              { title: "BFT Consensus", desc: "Experience HotStuff-inspired consensus in action" },
              { title: "AI Agents", desc: "Interact with native AI protocol participants" },
              { title: "Developer SDK", desc: "Build and deploy dApps on AI-native infrastructure" },
            ].map((item, i) => (
              <ScrollSection key={item.title} delay={i * 0.1}>
                <div className="glass-card-hover glow-border rounded-2xl p-6 text-center h-full">
        ...
        <div className="section-container py-20">
          <ScrollSection>
            <div className="max-w-xl mx-auto text-center">
              ...
              <h2 className="font-display text-3xl font-bold sm:text-4xl mb-4">
                Get notified when the public testnet goes{" "}
                <span className="gradient-text">live</span>
              </h2>
              <p className="text-muted-foreground mb-8">
                Drop your email and we'll let you know the moment it launches.
              </p>
              <EmailSignup />
            </div>
          </ScrollSection>
