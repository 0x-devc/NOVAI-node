...
#[test]
fn unknown_signal_type_byte_23_rejected_by_decoder() {
    // Build a base-length (66 byte) payload with signal_type byte = 23
    // (one past the current max, OracleAnchor = 22). The decoder runs
